...
from shared_variables import beam_size, prefix_size_pred_from, prefix_size_pred_to
...
only_compliant = True
lines, lines_t, lines_t2, lines_t3, maxlen, chars, char_indices, divisor, divisor2, divisor3, predict_size, target_indices_char = prepare_testing_data(
    eventlog, only_compliant)
...
with open('../output_files/results/suffix_and_remaining_time1_%s' % eventlog, 'wb') as csvfile:
    ...
    for prefix_size in range(prefix_size_pred_from, prefix_size_pred_to):
        ...
        for line, times, times2, times3 in izip(lines, lines_t, lines_t2, lines_t3):
            ...
            search_tree_root = MultileafTree(beam_size,
                                             encode(cropped_line, cropped_times, cropped_times3, maxlen, chars,
                ...
                if prediction_end_reached == False:
                    ...
                    for i in range(beam_size):
                        ...
                        search_tree_root.descendants[i] = MultileafTree(beam_size, temp_state_data,
                                                                        temp_cropped_line, temp_total_predicted_time,
                                                                        search_tree_root)
